...
for row in movies_table: # перебираем каждый внутренний список
    for elem in row: # в очередном внутреннем списке перебираем каждый элемент
        print(elem) # печатаем очередной элемент текущей строки
    print() # после того, как все элементы очередной строки напечатаны, добавляем отступ в одну пустую строку