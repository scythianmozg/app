...
timing_total = 0 # переменная-счётчик, перед циклом присваиваем ей значение 0

for movie in movies_table: # итератор movie по очереди перебирает списки внутри списка списков movies_table
    timing_total += movie[4] # добавляем к счётчику продолжительность очередного фильма (она находится в movie[4])
